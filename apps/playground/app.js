...
function addFieldsHtml(kind) {
  ...
  return `${common}
    ...
    <div class="field field--wide"><label for="af-args">Arguments</label><input id="af-args" class="mono" placeholder="examples/mock-mcp-source/server.mjs"><span class="field__hint">This source spawns the command and translates its graph to OKF. Only add servers you trust.</span></div>
